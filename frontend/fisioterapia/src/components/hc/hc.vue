...
<template>
  ...
  <div id="register">
    <div class="row">
      ...
      <p>Ingrese los datos solicitados para registrar un nuevo paciente </p>
      <div class="container">
        <div class="row">
          <div class="col-6">      <div class="input-group mb-1">
            <input
              type="text"
...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Historial</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Historia Clinica</button>
  </li>
<!--   <li class="nav-item" role="presentation">
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="accordion custom-header" id="accordionPanelsStayOpenExample">
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          ...
          >
            <v-icon name="io-construct-sharp" fill="red" scale="0.7" /> Escala
            Visual Analogica del dolor (EVA)
          </button>
        </h2>
        <div
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          ...
          >
            <v-icon name="ai-biorxiv-square" fill="blue" /> Pruebas de Imagen
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          ...
          >
            <v-icon name="io-construct-sharp" fill="red" scale="0.7" /> Plan
            Analitico de Atencion Fisioterapeutica
          </button>
        </h2>
        <div
  ...
  <div class="tab-pane fade" id="pills-disabled" role="tabpanel" aria-labelledby="pills-disabled-tab" tabindex="0">43</div>
</div>
