            ...
            <table class="table table-striped table-sm ">
                ...
                <tbody>
                    <tr v-for="cita in this.CitasAgendadas" :key="cita.id">
                        ...
                        <td><button type="button" class="btn btn-danger btn-sm" @click="ActualizaEstadoCita('NO',cita)">X</button><button type="button" class="btn btn-primary btn-sm" @click="ActualizaEstadoCita('SI',cita)">OK</button></td>
                    </tr>
